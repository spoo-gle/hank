...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'premonition':
				curStage = 'nevada';
				var bg:FlxSprite = new FlxSprite(-640, -1280).loadGraphic(Paths.image('Hank/nevada'));
				add(bg);
		...
		switch(stageCheck)
		{
			...
			case 'nevada':
					{
					curStage = 'nevada';
					var bg:FlxSprite = new FlxSprite(1000).loadGraphic(Paths.image('Hank/nevada'));
					add(bg);
					bg.scrollFactor.set(10, 10);
					bg.active = false;
					bg.updateHitbox();
